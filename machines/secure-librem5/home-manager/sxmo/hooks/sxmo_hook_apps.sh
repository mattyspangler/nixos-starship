...
write_line_app abook "$icon_bok Abook" "sxmo_terminal.sh abook"
#[ -n "$PLAN9" ] && write_line_app acme "$icon_edt Acme" "acme -c 1 -f $PLAN9/font/pelm/ascii.16.font"
...
write_line_app aichat "$icon_trm AI Chat" "sxmo_terminal.sh aichat"
...
write_line_flatpak com.belmoussaoui.Authenticator "$icon_lck Authenticator"
write_line_flatpak uk.co.piggz.amazfish "$icon_wat Amazfish"
#write_line_app audacity "$icon_mic Audacity" "audacity"
#write_line_app badwolf "$icon_glb Badwolf" "badwolf"
write_line_flatpak org.briarproject.Briar "$icon_msg Briar"
write_line_app calcurse "$icon_clk Calcurse" "sxmo_terminal.sh calcurse"
write_line_app calcure "$icon_clk Calcure" "sxmo_terminal.sh calcure"
write_line_flatpak org.gnome.Calendar "$icon_clk Calendar"
write_line_flatpak org.gnome.Calls "$icon_phn Calls"
write_line_app castero "$icon_mus Castero" "sxmo_terminal.sh castero"
#write_line_app chatty "$icon_msg Chatty" "chatty"
#write_line_flatpak sm.puri.Chatty "$icon_msg Chatty"
#([ "$SXMO_WM" = dwm ] && command -v clipmenu >/dev/null) && \
#	write_line_app clipmenu "$icon_bok Clipmenu" "clipmenu"
write_line_flatpak org.gnome.clocks "$icon_clk Clocks"
write_line_app cmus "$icon_mus Cmus" "sxmo_terminal.sh cmus"
write_line_flatpak org.gnome.Contacts "$icon_bok Contacts"
write_line_flatpak com.github.geigi.cozy "$icon_mus Cozy"
#write_line_app cpupower-gui "$icon_cfg Cpupower-gui" "cpupower-gui"
write_line_app crush "$icon_trm Crush" "sxmo_terminal.sh crush"
write_line_app dillo "$icon_glb Dillo" "dillo"
#write_line_app dino "$icon_msg Dino" "GDK_SCALE=1 dino"
write_line_flatpak im.dino.Dino "$icon_msg Dino"
...
write_line_app espeak "$icon_mic Espeak" "sxmo_terminal.sh espeak"
#write_line_app evince "$icon_bok Evince" "evince"
write_line_flatpak org.gnome.Evince "$icon_bok Evince"
write_line_flatpak org.gnome.Evolution "$icon_eml Evolution"
...
write_line_flatpak de.schmidhuberj.Flare "$icon_msg Flare"
write_line_flatpak com.github.tchx84.Flatseal "$icon_cfg Flatseal"
write_line_flatpak im.fluffychat.Fluffychat "$icon_msg Fluffychat"
#write_line_app foliate "$icon_bok Foliate" "foliate"
write_line_flatpak com.github.johnfactotum.Foliate "$icon_bok Foliate"
...
#write_line_flatpak io.freetubeapp.FreeTube "$icon_mvi FreeTube"
write_line_app fzf "$icon_trm FZF" "sxmo_terminal.sh fzf"
...
write_line_flatpak org.gabmus.gfeeds "$icon_rss GFeeds"
...
#write_line_flatpak org.gpodder.gpodder-adaptive "$icon_rss gPodder"
#write_line_app gucharmap "$icon_inf Gucharmap" "gucharmap"
write_line_app gurk-rs "$icon_msg Gurk-rs" "sxmo_terminal.sh gurk-rs"
...
write_line_flatpak xyz.slothlife.Jogger "$icon_str Jogger"
#write_line_app kasts "$icon_rss Kasts" "kasts"
#write_line_app kcalc "$icon_clc KCalc" "kcalc"
write_line_app keepassxc "$icon_lck KeePassXC" "keepassxc"
#write_line_flatpak org.keepassxc.KeePassXC "$icon_lck KeePassXC"
write_line_app khal "$icon_clk Khal" "sxmo_terminal.sh khal"
write_line_app khard "$icon_bok Khard" "sxmo_terminal.sh khard"
...
write_line_app lynx "$icon_glb Lynx" "sxmo_terminal.sh lynx"
#write_line_app lollypop "$icon_mus Lollypop" "lollypop"
write_line_flatpak org.gnome.Lollypop "$icon_mus Lollypop"
...
write_line_app mc "$icon_dir MC" "sxmo_terminal.sh mc"
write_line_app megapixels "$icon_cam Megapixels" "megapixels"
#write_line_app mepo "$icon_map Mepo" "mepo"
write_line_flatpak org.meshtastic.meshtasticd "$icon_msg Meshtasticd"
...
write_line_app waydroid "$icon_flk Molly" "waydroid app launch im.molly.app" # TODO: figure out best icon for this
#write_line_app moment "$icon_msg Moment" "moment"
write_line_flatpak io.github.seadve.Mousai "$icon_mus Mousai"
write_line_app mpv "$icon_mvi Mpv" "mpv"
...
write_line_flatpak org.gnome.Music "$icon_mus Music"
write_line_app mutt "$icon_eml Mutt" "sxmo_terminal.sh mutt"
#write_line_flatpak net.mullvad.MullvadBrowser "$icon_glb Mullvad Browser"
#write_line_app nano "$icon_edt Nano" "sxmo_terminal.sh nano"
#write_line_app nautilus "$icon_dir Nautilus" "nautilus"
write_line_app navi "$icon_bok Navi" "sxmo_terminal.sh navi"
...
write_line_flatpak im.nheko.Nheko "$icon_msg Nheko"
...
write_line_app octave "$icon_clc Octave" "sxmo_terminal.sh octave"
#write_line_app offpunk "$icon_glb Offpunk" "sxmo_terminal.sh offpunk"
write_line_flatpak app.organicmaps.desktop "$icon_map \"Organic Maps\""
write_line_flatpak io.github.rinigus.OSMScoutServer "$icon_map OSMScoutServer"
#write_line_app osmin "$icon_map Osmin" "osmin"
#write_line_app papers "$icon_bok Papers" "papers"
#write_line_app pass "$icon_lck Pass" "sxmo_terminal.sh pass"
#write_line_app pavucontrol "$icon_mus Pavucontrol" "pavucontrol"
write_line_app peaclock "$icon_clk Peaclock" "sxmo_terminal.sh peaclock"
#write_line_app pidgin "$icon_msg Pidgin" "pidgin"
write_line_flatpak im.pidgin.Pidgin "$icon_msg Pidgin"
write_line_flatpak de.schmidhuberj.tubefeeder "$icon_msg Pipeline"
#write_line_app podboat "$icon_rss Podboat" "sxmo_terminal.sh podboat"
#write_line_flatpak org.gnome.Podcasts "$icon_rss Podcasts"
...
#write_line_flatpak ch.protonmail.protonmail-bridge "$icon_eml \"Protonmail Bridge\""
write_line_flatpak com.protonvpn.www "$icon_lck ProtonVPN"
...
write_line_flatpak io.github.rinigus.PureMaps "$icon_map \"Pure Maps\""
...
#write_line_app remind "$icon_clk Remind" "sxmo_terminal.sh remind"
#write_line_app sacc "$icon_glb Sacc" "sxmo_terminal.sh sacc i-logout.cz/1/bongusta"
write_line_app sc-im "$icon_clc Sc-im" "sxmo_terminal.sh sc-im"
...
write_line_flatpak org.gnome.Shotwell "$icon_img Shotwell"
...
write_line_flatpak net.mkiol.SpeechNote "$icon_mic SpeechNote"
#([ "$SXMO_WM" = dwm ] && command -v st >/dev/null) && \
#	write_line "$icon_trm St" "st -e $SHELL"
#write_line_flatpak com.valvesoftware.Steam "$icon_gam Steam"
...
write_line_flatpak me.kozec.syncthingtk "$icon_rld Syncthing GTK"
#([ "$SXMO_WM" = dwm ] && command -v tabbed >/dev/null) && \
#	write_line_app tabbed "$icon_grd Tabbed" "sxmo_tabbed.sh"
#write_line_app tartube "$icon_mvi Tartube" "sxmo_terminal.sh tartube"
...
#write_line_flatpak org.mozilla.Thunderbird "$icon_eml Thunderbird"
#write_line_app tilix "$icon_trm Tilix" "tilix"
write_line_app toot "$icon_msg Toot" "sxmo_terminal.sh toot"
...
write_line_app tty-clock "$icon_clk TTY-Clock" "sxmo_terminal.sh tty-clock"
write_line_flatpak dev.geopjr.Tuba "$icon_msg Tuba"
write_line_flatpak de.schmidhuberj.tubefeeder "$icon_mvi Tubefeeder"
#write_line_app tuir "$icon_red Tuir" "sxmo_terminal.sh tuir"
write_line_app tuisky "$icon_msg Tuisky" "sxmo_terminal.sh tuisky"
#write_line_app tut "$icon_msg Tut" "sxmo_terminal.sh tut"
write_line_app viu "$icon_img Viu" "sxmo_terminal.sh viu"
...
write_line_flatpak io.github.spacingbat3.webcord "$icon_msg Webcord"
write_line_app weechat "$icon_msg Weechat" "sxmo_terminal.sh weechat"
write_line_flatpak org.gnome.Weather "$icon_wtr Weather"
#write_line_app wike "$icon_bok Wike" "wike"
write_line_app wordgrinder "$icon_edt Wordgrinder" "sxmo_terminal.sh wordgrinder"
write_line_app wyrd "$icon_clk Wyrd" "sxmo_terminal.sh wyrd"
...
write_line_app xplr "$icon_dir XPLR" "sxmo_terminal.sh xplr"
write_line_app youtube-tui "$icon_mvi Youtube TUI" "sxmo_terminal.sh youtube-tui"
#write_line_app yt-dlp "$icon_mvi yt-dlp" "sxmo_terminal.sh yt-dlp"
#write_line_app zathura "$icon_bok Zathura" "zathura"
write_line_app zsh "$icon_trm ZSH" "sxmo_terminal.sh zsh"
